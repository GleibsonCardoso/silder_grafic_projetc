...
import gerador_dados as grafic
...
fig, ax = plt.subplots()
line, = plt.plot(ang,grafico(valinit))
ax.set_xlabel('Ângulo de incidencia')

plt.subplots_adjust(bottom=0.25)

#definição de botão de controle (slider botton)

ax_indice = plt.axes([0.25, 0.1, 0.5, 0.03])

#Propriedades do Slider

mudanca = Slider(ax_indice, 
                 label='n do analito', 
                 valmin= 1.00, 
                 valmax= 3.50, 
                 valinit= 1.33, 
